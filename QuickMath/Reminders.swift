...
enum Reminders {
    private static let identifier = "cooldown.daily.reminder"
    ...
    static func schedule(hour: Int, minute: Int) {
        ...
        content.title = "Time to decide on a purchase"
        content.body = "Check your cooldown list — some items are ready for a decision."
